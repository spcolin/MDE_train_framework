...
parser.add_argument('--retrain',type=bool,default=True,help='if used with checkpoint_path, will restart training from step zero')
...
parser.add_argument('--eval_freq',type=int, default=1000,help='Online evaluation frequency in global steps')
parser.add_argument('--eval_summary_directory',type=str,help='output directory for eval summary, if empty outputs to checkpoint folder', default='')

parser.add_argument('--project_path',type=str,default='/home/colin/code/depth_train_framework/v4/')
parser.add_argument('--one_iter',type=bool,default=False)
...
args.filenames_file= args.project_path+'data_splits/eigen_train_files_with_gt.txt'
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    dataloader = KITTI_DataLoader(args, 'train')
...
def main():
    ...
    #     command = 'cp train_tools/train_kitti.py ' + aux_out_path
    #     os.system(command)
